...
do
    local ui =  ClonedService("CoreGui"):FindFirstChild("NBTxTP Lib")
    if ui then
        ui:Destroy()
    end
end
...
Atomlib.Parent = ClonedService("CoreGui")
...
function create:Win()
    ...
    local tween = ClonedService("TweenService")
    ...
    ClonedService("UserInputService").InputBegan:Connect(function(input)
...
function page:addpage()
    ...
    ClonedService("RunService").Stepped:Connect(function ()
        pcall(function ()
...
function ems:Slder(text,min,max,de,callback)
    ...
    local function move(input)
        ...
        ClonedService("UserInputService").InputChanged:Connect(
            function(input)
