...
if ClonedService("CoreGui"):FindFirstChild("UICopied") then
    ClonedService("CoreGui"):FindFirstChild("UICopied"):Destroy()
end
...
ClonedService("TweenService"):Create(Frame, TweenInfo.new(.25), {Position = Position}):Play()
end
...
ClonedService("UserInputService").InputChanged:Connect(function(input)
...
UICopied.Parent = ClonedService("CoreGui")
